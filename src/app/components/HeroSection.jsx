      ...
      <div className='grid grid-cols-1 sm:grid-cols-12'>
        ...
        >
          <h1 className='text-white mb-4 text-4xl sm:text-5xl lg:text-6xl lg:leading-normal font-extrabold'>
            <span className='text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-secondary-600'>
              Hello, I&apos;m{' '}
            </span>
            <br></br>
            <TypeAnimation
        ...
        >
          <div className='rounded-full  lg:w-[400px] lg:h-[400px] relative bg-gray-800'>
            <Image
